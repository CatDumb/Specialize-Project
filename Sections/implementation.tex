...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Example response:
        \begin{figure}[H]
            \includegraphics[width=\textwidth]{assets/images/Implementation/nearby_disable_response.png.png}
    ...
    \begin{itemize}
        ...
        \item Example response:
        \begin{figure}[H]
            \includegraphics[width=\textwidth]{assets/images/Implementation/stop_detail_response.png.png}
