...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{assets/images/Implementation/dbcompass.png}
...
\begin{figure}[H]
    ...
    \subfloat[The iOS account registration view.]{
        \includegraphics[width=0.4\linewidth]{assets/images/Implementation/register_view.png}
        \label{fig:ios_register_view}
    }
    \hspace{0.5cm} % Add a horizontal space of 1cm
    \subfloat[The iOS app's login view.]{
        \includegraphics[width=0.4\linewidth]{assets/images/Implementation/login_view.png}
